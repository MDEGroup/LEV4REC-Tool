 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.ReactiveHandlerImpl#getEvent <em>Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReactiveHandlerImpl extends RecommendationHandlerImpl implements ReactiveHandler
{
  ...
  {
    return RsDslPackage.Literals.REACTIVE_HANDLER;
  }
    ...
    if (event != null && event.eIsProxy())
    {
      ...
      if (event != oldEvent)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RsDslPackage.REACTIVE_HANDLER__EVENT, oldEvent, event));
      }
    }
    return event;
  }
  ...
  public void setEvent(UserEvent newEvent)
  {
    ...
    event = newEvent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.REACTIVE_HANDLER__EVENT, oldEvent, event));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.REACTIVE_HANDLER__EVENT:
