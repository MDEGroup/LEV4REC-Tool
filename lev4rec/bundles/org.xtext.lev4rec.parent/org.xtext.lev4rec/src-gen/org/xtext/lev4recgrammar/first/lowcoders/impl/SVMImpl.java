 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.SVMImpl#getNumEpochs <em>Num Epochs</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.SVMImpl#getLearningRate <em>Learning Rate</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.SVMImpl#getMiniBatchSize <em>Mini Batch Size</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.SVMImpl#getKernel <em>Kernel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SVMImpl extends RecommendationSystemImpl implements SVM
{
  ...
  public void setNumEpochs(int newNumEpochs)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.SVM__NUM_EPOCHS, oldNumEpochs, numEpochs));
  }
  ...
  public void setLearningRate(int newLearningRate)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.SVM__LEARNING_RATE, oldLearningRate, learningRate));
  }
  ...
  public void setMiniBatchSize(int newMiniBatchSize)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.SVM__MINI_BATCH_SIZE, oldMiniBatchSize, miniBatchSize));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LowcodersPackage.SVM__NUM_EPOCHS:
        return getNumEpochs();
      case LowcodersPackage.SVM__LEARNING_RATE:
        return getLearningRate();
      case LowcodersPackage.SVM__MINI_BATCH_SIZE:
