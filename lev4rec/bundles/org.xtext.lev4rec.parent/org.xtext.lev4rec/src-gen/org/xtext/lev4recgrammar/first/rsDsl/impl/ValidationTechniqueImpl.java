 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.ValidationTechniqueImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.ValidationTechniqueImpl#getNOfRecommendations <em>NOf Recommendations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValidationTechniqueImpl extends MinimalEObjectImpl.Container implements ValidationTechnique
{
  ...
  {
    return RsDslPackage.Literals.VALIDATION_TECHNIQUE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.VALIDATION_TECHNIQUE__NAME, oldName, name));
  }
  ...
  public void setNOfRecommendations(int newNOfRecommendations)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.VALIDATION_TECHNIQUE__NOF_RECOMMENDATIONS, oldNOfRecommendations, nOfRecommendations));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.VALIDATION_TECHNIQUE__NAME:
        return getName();
      case RsDslPackage.VALIDATION_TECHNIQUE__NOF_RECOMMENDATIONS:
