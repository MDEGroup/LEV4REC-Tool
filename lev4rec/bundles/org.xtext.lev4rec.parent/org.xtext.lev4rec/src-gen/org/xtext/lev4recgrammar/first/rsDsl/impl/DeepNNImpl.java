 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DeepNNImpl#getNumEpochs <em>Num Epochs</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DeepNNImpl#getLearningRate <em>Learning Rate</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DeepNNImpl#getMiniBatchSize <em>Mini Batch Size</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DeepNNImpl#getNumHiddenLayer <em>Num Hidden Layer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeepNNImpl extends RecommendationSystemImpl implements DeepNN
{
  ...
  {
    return RsDslPackage.Literals.DEEP_NN;
  }
  ...
  public void setNumEpochs(int newNumEpochs)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.DEEP_NN__NUM_EPOCHS, oldNumEpochs, numEpochs));
  }
  ...
  public void setLearningRate(int newLearningRate)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.DEEP_NN__LEARNING_RATE, oldLearningRate, learningRate));
  }
  ...
  public void setMiniBatchSize(int newMiniBatchSize)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.DEEP_NN__MINI_BATCH_SIZE, oldMiniBatchSize, miniBatchSize));
  }
  ...
  public void setNumHiddenLayer(int newNumHiddenLayer)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.DEEP_NN__NUM_HIDDEN_LAYER, oldNumHiddenLayer, numHiddenLayer));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.DEEP_NN__NUM_EPOCHS:
        return getNumEpochs();
      case RsDslPackage.DEEP_NN__LEARNING_RATE:
        return getLearningRate();
      case RsDslPackage.DEEP_NN__MINI_BATCH_SIZE:
        return getMiniBatchSize();
      case RsDslPackage.DEEP_NN__NUM_HIDDEN_LAYER:
