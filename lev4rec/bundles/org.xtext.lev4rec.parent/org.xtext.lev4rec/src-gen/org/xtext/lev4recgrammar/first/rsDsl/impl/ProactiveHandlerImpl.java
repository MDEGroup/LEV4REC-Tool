 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.ProactiveHandlerImpl#isCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProactiveHandlerImpl extends RecommendationHandlerImpl implements ProactiveHandler
{
  ...
  {
    return RsDslPackage.Literals.PROACTIVE_HANDLER;
  }
  ...
  public void setCondition(boolean newCondition)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.PROACTIVE_HANDLER__CONDITION, oldCondition, condition));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.PROACTIVE_HANDLER__CONDITION:
        return isCondition();
    }
