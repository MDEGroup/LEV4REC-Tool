 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.BayesianImpl#getNumEpochs <em>Num Epochs</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.BayesianImpl#getLearningRate <em>Learning Rate</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.BayesianImpl#getMiniBatchSize <em>Mini Batch Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BayesianImpl extends RecommendationSystemImpl implements Bayesian
{
  ...
  {
    return RsDslPackage.Literals.BAYESIAN;
  }
  ...
  public void setNumEpochs(int newNumEpochs)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.BAYESIAN__NUM_EPOCHS, oldNumEpochs, numEpochs));
  }
  ...
  public void setLearningRate(int newLearningRate)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.BAYESIAN__LEARNING_RATE, oldLearningRate, learningRate));
  }
  ...
  public void setMiniBatchSize(int newMiniBatchSize)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.BAYESIAN__MINI_BATCH_SIZE, oldMiniBatchSize, miniBatchSize));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.BAYESIAN__NUM_EPOCHS:
        return getNumEpochs();
      case RsDslPackage.BAYESIAN__LEARNING_RATE:
        return getLearningRate();
      case RsDslPackage.BAYESIAN__MINI_BATCH_SIZE:
