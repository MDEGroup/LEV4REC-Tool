...
import org.xtext.lev4recgrammar.first.rsDsl.MutationOperation;
...
import org.xtext.lev4recgrammar.first.rsDsl.RatingType;
import org.xtext.lev4recgrammar.first.rsDsl.RawFormat;
...
import org.xtext.lev4recgrammar.first.rsDsl.SearchStrategy;
...
import org.xtext.lev4recgrammar.first.rsDsl.UserStudyAnalysis;
import org.xtext.lev4recgrammar.first.rsDsl.UserStudyType;
 ...
 * @generated
 */
public class RsDslPackageImpl extends EPackageImpl implements RsDslPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.lev4recgrammar.first.rsDsl.RsDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private RsDslPackageImpl()
  {
    super(eNS_URI, RsDslFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link RsDslPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static RsDslPackage init()
  {
    if (isInited) return (RsDslPackage)EPackage.Registry.INSTANCE.getEPackage(RsDslPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredRsDslPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    RsDslPackageImpl theRsDslPackage = registeredRsDslPackage instanceof RsDslPackageImpl ? (RsDslPackageImpl)registeredRsDslPackage : new RsDslPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theRsDslPackage.createPackageContents();

    // Initialize created meta-data
    theRsDslPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theRsDslPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(RsDslPackage.eNS_URI, theRsDslPackage);
    return theRsDslPackage;
  }
   ...
   */
  @Override
  public RsDslFactory getRsDslFactory()
  {
    return (RsDslFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(arffEClass, org.xtext.lev4recgrammar.first.rsDsl.ARFF.class, "ARFF", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getARFF_Variables(), this.getVariable(), null, "variables", null, 0, -1, org.xtext.lev4recgrammar.first.rsDsl.ARFF.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(svmEClass, org.xtext.lev4recgrammar.first.rsDsl.SVM.class, "SVM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getSVM_NumEpochs(), ecorePackage.getEInt(), "numEpochs", null, 0, 1, org.xtext.lev4recgrammar.first.rsDsl.SVM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSVM_LearningRate(), ecorePackage.getEInt(), "learningRate", null, 0, 1, org.xtext.lev4recgrammar.first.rsDsl.SVM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSVM_MiniBatchSize(), ecorePackage.getEInt(), "miniBatchSize", null, 0, 1, org.xtext.lev4recgrammar.first.rsDsl.SVM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSVM_Kernel(), this.getKernelType(), "kernel", null, 0, 1, org.xtext.lev4recgrammar.first.rsDsl.SVM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
