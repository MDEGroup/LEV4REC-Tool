 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.UserStudyImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.UserStudyImpl#getAnalysis <em>Analysis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserStudyImpl extends ValidationTechniqueImpl implements UserStudy
{
  ...
  {
    return RsDslPackage.Literals.USER_STUDY;
  }
  ...
  public void setType(UserStudyType newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.USER_STUDY__TYPE, oldType, type));
  }
  ...
  public void setAnalysis(UserStudyAnalysis newAnalysis)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.USER_STUDY__ANALYSIS, oldAnalysis, analysis));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.USER_STUDY__TYPE:
        return getType();
      case RsDslPackage.USER_STUDY__ANALYSIS:
        return getAnalysis();
    }
