 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.GeneticAlgorithmImpl#getFitnessFunction <em>Fitness Function</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.GeneticAlgorithmImpl#getSearchStrategy <em>Search Strategy</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.GeneticAlgorithmImpl#getMutationOperator <em>Mutation Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneticAlgorithmImpl extends RecommendationSystemImpl implements GeneticAlgorithm
{
  ...
  {
    return RsDslPackage.Literals.GENETIC_ALGORITHM;
  }
  ...
  public void setFitnessFunction(String newFitnessFunction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.GENETIC_ALGORITHM__FITNESS_FUNCTION, oldFitnessFunction, fitnessFunction));
  }
  ...
  public void setSearchStrategy(SearchStrategy newSearchStrategy)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.GENETIC_ALGORITHM__SEARCH_STRATEGY, oldSearchStrategy, searchStrategy));
  }
  ...
  public void setMutationOperator(MutationOperation newMutationOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.GENETIC_ALGORITHM__MUTATION_OPERATOR, oldMutationOperator, mutationOperator));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.GENETIC_ALGORITHM__FITNESS_FUNCTION:
        return getFitnessFunction();
      case RsDslPackage.GENETIC_ALGORITHM__SEARCH_STRATEGY:
        return getSearchStrategy();
      case RsDslPackage.GENETIC_ALGORITHM__MUTATION_OPERATOR:
