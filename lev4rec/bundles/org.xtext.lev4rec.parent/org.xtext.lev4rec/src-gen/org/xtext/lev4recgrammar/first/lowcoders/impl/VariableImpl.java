 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.VariableImpl#isIsMissingValueAllowed <em>Is Missing Value Allowed</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.VariableImpl#isIsMultiple <em>Is Multiple</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.VariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.VariableImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.VariableImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.VariableImpl#getPreprocessing <em>Preprocessing</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends MinimalEObjectImpl.Container implements Variable
{
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.VARIABLE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case LowcodersPackage.VARIABLE__IS_MULTIPLE:
        return isIsMultiple();
      case LowcodersPackage.VARIABLE__NAME:
        return getName();
