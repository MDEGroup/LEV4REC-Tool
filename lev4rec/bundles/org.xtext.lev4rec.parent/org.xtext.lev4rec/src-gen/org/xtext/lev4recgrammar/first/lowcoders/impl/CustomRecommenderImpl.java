 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.CustomRecommenderImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.CustomRecommenderImpl#getRequiredTools <em>Required Tools</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomRecommenderImpl extends RecommendationSystemImpl implements CustomRecommender
{
  ...
  public EList<String> getRequiredTools()
  {
    ...
    {
      requiredTools = new EDataTypeEList<String>(String.class, this, LowcodersPackage.CUSTOM_RECOMMENDER__REQUIRED_TOOLS);
    }
