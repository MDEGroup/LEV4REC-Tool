 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.FeedForwardNNImpl#getNumEpochs <em>Num Epochs</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.FeedForwardNNImpl#getLearningRate <em>Learning Rate</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.FeedForwardNNImpl#getMiniBatchSize <em>Mini Batch Size</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.FeedForwardNNImpl#getSolver <em>Solver</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.FeedForwardNNImpl#getAlpha <em>Alpha</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.FeedForwardNNImpl#getActivationFunction <em>Activation Function</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.FeedForwardNNImpl#getRandomState <em>Random State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeedForwardNNImpl extends RecommendationSystemImpl implements FeedForwardNN
{
  ...
  public void setNumEpochs(int newNumEpochs)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.FEED_FORWARD_NN__NUM_EPOCHS, oldNumEpochs, numEpochs));
  }
  ...
  public void setLearningRate(int newLearningRate)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.FEED_FORWARD_NN__LEARNING_RATE, oldLearningRate, learningRate));
  }
  ...
  public void setMiniBatchSize(int newMiniBatchSize)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.FEED_FORWARD_NN__MINI_BATCH_SIZE, oldMiniBatchSize, miniBatchSize));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LowcodersPackage.FEED_FORWARD_NN__NUM_EPOCHS:
        return getNumEpochs();
      case LowcodersPackage.FEED_FORWARD_NN__LEARNING_RATE:
        return getLearningRate();
      case LowcodersPackage.FEED_FORWARD_NN__MINI_BATCH_SIZE:
