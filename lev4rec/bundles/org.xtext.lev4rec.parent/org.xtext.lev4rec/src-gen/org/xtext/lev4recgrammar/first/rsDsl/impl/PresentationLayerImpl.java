 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.PresentationLayerImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.PresentationLayerImpl#getRecommendations <em>Recommendations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PresentationLayerImpl extends MinimalEObjectImpl.Container implements PresentationLayer
{
  ...
  {
    return RsDslPackage.Literals.PRESENTATION_LAYER;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.PRESENTATION_LAYER__NAME, oldName, name));
  }
  ...
  public RecommendedItem getRecommendations()
  {
    if (recommendations != null && recommendations.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RsDslPackage.PRESENTATION_LAYER__RECOMMENDATIONS, oldRecommendations, recommendations));
      }
    }
  ...
  public void setRecommendations(RecommendedItem newRecommendations)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.PRESENTATION_LAYER__RECOMMENDATIONS, oldRecommendations, recommendations));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.PRESENTATION_LAYER__NAME:
        return getName();
      case RsDslPackage.PRESENTATION_LAYER__RECOMMENDATIONS:
