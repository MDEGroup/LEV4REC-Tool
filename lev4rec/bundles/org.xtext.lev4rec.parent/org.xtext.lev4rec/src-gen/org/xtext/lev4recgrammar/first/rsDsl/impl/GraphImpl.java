 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.GraphImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.GraphImpl#getRelations <em>Relations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GraphImpl extends DataStructureImpl implements Graph
{
  ...
  {
    return RsDslPackage.Literals.GRAPH;
  }
  ...
  public EList<Variable> getNodes()
  {
    if (nodes == null)
    {
      nodes = new EObjectResolvingEList<Variable>(Variable.class, this, RsDslPackage.GRAPH__NODES);
    }
    return nodes;
  }
  ...
  public NotificationChain basicSetRelations(VariableRelation newRelations, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RsDslPackage.GRAPH__RELATIONS, oldRelations, newRelations);
  ...
  public void setRelations(VariableRelation newRelations)
  {
    if (newRelations != relations)
    {
      ...
      if (relations != null)
        msgs = ((InternalEObject)relations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RsDslPackage.GRAPH__RELATIONS, null, msgs);
      if (newRelations != null)
        msgs = ((InternalEObject)newRelations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RsDslPackage.GRAPH__RELATIONS, null, msgs);
      msgs = basicSetRelations(newRelations, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.GRAPH__RELATIONS, newRelations, newRelations));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RsDslPackage.GRAPH__RELATIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.GRAPH__NODES:
        return getNodes();
      case RsDslPackage.GRAPH__RELATIONS:
        return getRelations();
    }
