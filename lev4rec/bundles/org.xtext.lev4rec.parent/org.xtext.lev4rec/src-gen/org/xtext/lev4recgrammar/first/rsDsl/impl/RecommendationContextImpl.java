 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.RecommendationContextImpl#isIsProactiveSystem <em>Is Proactive System</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.RecommendationContextImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.RecommendationContextImpl#getUserContext <em>User Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RecommendationContextImpl extends MinimalEObjectImpl.Container implements RecommendationContext
{
  ...
  {
    return RsDslPackage.Literals.RECOMMENDATION_CONTEXT;
  }
  ...
  public void setIsProactiveSystem(boolean newIsProactiveSystem)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.RECOMMENDATION_CONTEXT__IS_PROACTIVE_SYSTEM, oldIsProactiveSystem, isProactiveSystem));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.RECOMMENDATION_CONTEXT__NAME, oldName, name));
  }
  ...
  public DataStructure getUserContext()
  {
    if (userContext != null && userContext.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RsDslPackage.RECOMMENDATION_CONTEXT__USER_CONTEXT, oldUserContext, userContext));
      }
    }
    return userContext;
  }
  ...
  public void setUserContext(DataStructure newUserContext)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.RECOMMENDATION_CONTEXT__USER_CONTEXT, oldUserContext, userContext));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.RECOMMENDATION_CONTEXT__IS_PROACTIVE_SYSTEM:
        return isIsProactiveSystem();
      case RsDslPackage.RECOMMENDATION_CONTEXT__NAME:
        return getName();
      case RsDslPackage.RECOMMENDATION_CONTEXT__USER_CONTEXT:
