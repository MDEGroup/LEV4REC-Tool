 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.RecommendationHandlerImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.RecommendationHandlerImpl#getWebService <em>Web Service</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.RecommendationHandlerImpl#getContext <em>Context</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.RecommendationHandlerImpl#getUsage <em>Usage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RecommendationHandlerImpl extends MinimalEObjectImpl.Container implements RecommendationHandler
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.RECOMMENDATION_HANDLER__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LowcodersPackage.RECOMMENDATION_HANDLER__NAME:
        return getName();
