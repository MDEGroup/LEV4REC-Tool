 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.VSCodePluginImpl#getHandler <em>Handler</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VSCodePluginImpl extends PresentationLayerImpl implements VSCodePlugin
{
  ...
  {
    return RsDslPackage.Literals.VS_CODE_PLUGIN;
  }
  ...
  public EList<RecommendationHandler> getHandler()
  {
    if (handler == null)
    {
      handler = new EObjectResolvingEList<RecommendationHandler>(RecommendationHandler.class, this, RsDslPackage.VS_CODE_PLUGIN__HANDLER);
    }
    return handler;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.VS_CODE_PLUGIN__HANDLER:
        return getHandler();
    }
