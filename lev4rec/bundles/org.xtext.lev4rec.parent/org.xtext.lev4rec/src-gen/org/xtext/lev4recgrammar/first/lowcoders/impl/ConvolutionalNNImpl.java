...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Convolutional NN</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.ConvolutionalNNImpl#getNumEpochs <em>Num Epochs</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.ConvolutionalNNImpl#getLearningRate <em>Learning Rate</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.ConvolutionalNNImpl#getMiniBatchSize <em>Mini Batch Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConvolutionalNNImpl extends RecommendationSystemImpl implements ConvolutionalNN
{
  /**
  ...
  {
    return LowcodersPackage.Literals.CONVOLUTIONAL_NN;
  }
  ...
  public void setNumEpochs(int newNumEpochs)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.CONVOLUTIONAL_NN__NUM_EPOCHS, oldNumEpochs, numEpochs));
  }
  ...
  public void setLearningRate(int newLearningRate)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.CONVOLUTIONAL_NN__LEARNING_RATE, oldLearningRate, learningRate));
  }
  ...
  public void setMiniBatchSize(int newMiniBatchSize)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.CONVOLUTIONAL_NN__MINI_BATCH_SIZE, oldMiniBatchSize, miniBatchSize));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LowcodersPackage.CONVOLUTIONAL_NN__NUM_EPOCHS:
        return getNumEpochs();
      case LowcodersPackage.CONVOLUTIONAL_NN__LEARNING_RATE:
        return getLearningRate();
      case LowcodersPackage.CONVOLUTIONAL_NN__MINI_BATCH_SIZE:
