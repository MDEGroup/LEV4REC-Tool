 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.GroundTruthExtractionImpl#getSizeGT <em>Size GT</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.GroundTruthExtractionImpl#getSplittingRules <em>Splitting Rules</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.GroundTruthExtractionImpl#getTargetVariable <em>Target Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroundTruthExtractionImpl extends MinimalEObjectImpl.Container implements GroundTruthExtraction
{
  ...
  public EList<String> getSplittingRules()
  {
    ...
    {
      splittingRules = new EDataTypeEList<String>(String.class, this, LowcodersPackage.GROUND_TRUTH_EXTRACTION__SPLITTING_RULES);
    }
