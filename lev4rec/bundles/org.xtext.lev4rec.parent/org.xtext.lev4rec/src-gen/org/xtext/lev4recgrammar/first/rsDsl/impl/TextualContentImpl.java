 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.TextualContentImpl#getRootPath <em>Root Path</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.TextualContentImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextualContentImpl extends DataStructureImpl implements TextualContent
{
  ...
  {
    return RsDslPackage.Literals.TEXTUAL_CONTENT;
  }
  ...
  public void setRootPath(String newRootPath)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.TEXTUAL_CONTENT__ROOT_PATH, oldRootPath, rootPath));
  }
  ...
  public Variable getContents()
  {
    if (contents != null && contents.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RsDslPackage.TEXTUAL_CONTENT__CONTENTS, oldContents, contents));
      }
    }
    return contents;
  }
  ...
  public void setContents(Variable newContents)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.TEXTUAL_CONTENT__CONTENTS, oldContents, contents));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.TEXTUAL_CONTENT__ROOT_PATH:
        return getRootPath();
      case RsDslPackage.TEXTUAL_CONTENT__CONTENTS:
