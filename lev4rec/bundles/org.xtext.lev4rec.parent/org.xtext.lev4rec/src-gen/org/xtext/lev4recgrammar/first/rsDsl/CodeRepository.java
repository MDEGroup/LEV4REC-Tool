 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.CodeRepository#isMetadata <em>Metadata</em>}</li>
 * </ul>
 *
 * @see org.xtext.lev4recgrammar.first.rsDsl.RsDslPackage#getCodeRepository()
 * @model
 * @generated
 */
public interface CodeRepository extends DataSource
{
   ...
   * @see org.xtext.lev4recgrammar.first.rsDsl.RsDslPackage#getCodeRepository_Metadata()
   * @model
   * @generated
   */
  boolean isMetadata();
  ...
  /**
   * Sets the value of the '{@link org.xtext.lev4recgrammar.first.rsDsl.CodeRepository#isMetadata <em>Metadata</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
