 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.MachineLearningBasedRSImpl#getNumEpochs <em>Num Epochs</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.MachineLearningBasedRSImpl#getLearningRate <em>Learning Rate</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.MachineLearningBasedRSImpl#getMiniBatchSize <em>Mini Batch Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MachineLearningBasedRSImpl extends RecommendationSystemImpl implements MachineLearningBasedRS
{
  ...
  {
    return RsDslPackage.Literals.MACHINE_LEARNING_BASED_RS;
  }
  ...
  public void setNumEpochs(int newNumEpochs)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.MACHINE_LEARNING_BASED_RS__NUM_EPOCHS, oldNumEpochs, numEpochs));
  }
  ...
  public void setLearningRate(int newLearningRate)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.MACHINE_LEARNING_BASED_RS__LEARNING_RATE, oldLearningRate, learningRate));
  }
  ...
  public void setMiniBatchSize(int newMiniBatchSize)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.MACHINE_LEARNING_BASED_RS__MINI_BATCH_SIZE, oldMiniBatchSize, miniBatchSize));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.MACHINE_LEARNING_BASED_RS__NUM_EPOCHS:
        return getNumEpochs();
      case RsDslPackage.MACHINE_LEARNING_BASED_RS__LEARNING_RATE:
        return getLearningRate();
      case RsDslPackage.MACHINE_LEARNING_BASED_RS__MINI_BATCH_SIZE:
