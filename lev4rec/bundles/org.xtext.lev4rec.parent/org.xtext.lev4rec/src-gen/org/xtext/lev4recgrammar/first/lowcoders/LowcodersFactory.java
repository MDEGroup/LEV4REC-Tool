...
public interface LowcodersFactory extends EFactory
{
   ...
   * @generated
   */
  LowcodersFactory eINSTANCE = org.xtext.lev4recgrammar.first.lowcoders.impl.LowcodersFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Recommendation System</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Recommendation System</em>'.
   * @generated
   */
  RecommendationSystem createRecommendationSystem();

  /**
   * Returns a new object of class '<em>Validation Technique</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Validation Technique</em>'.
   * @generated
   */
  ValidationTechnique createValidationTechnique();
  ...
  /**
   * Returns a new object of class '<em>Jupyter Notebook</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Jupyter Notebook</em>'.
   * @generated
   */
  JupyterNotebook createJupyterNotebook();
