 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.AdditiveFeedbackImpl#getNumOfInsertion <em>Num Of Insertion</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.AdditiveFeedbackImpl#getRecommender <em>Recommender</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditiveFeedbackImpl extends FeedbackImpl implements AdditiveFeedback
{
  ...
  {
    return RsDslPackage.Literals.ADDITIVE_FEEDBACK;
  }
  ...
  public void setNumOfInsertion(int newNumOfInsertion)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.ADDITIVE_FEEDBACK__NUM_OF_INSERTION, oldNumOfInsertion, numOfInsertion));
  }
  ...
  public RecommendationSystem getRecommender()
  {
    if (recommender != null && recommender.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RsDslPackage.ADDITIVE_FEEDBACK__RECOMMENDER, oldRecommender, recommender));
      }
    }
    return recommender;
  }
  ...
  public void setRecommender(RecommendationSystem newRecommender)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.ADDITIVE_FEEDBACK__RECOMMENDER, oldRecommender, recommender));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.ADDITIVE_FEEDBACK__NUM_OF_INSERTION:
        return getNumOfInsertion();
      case RsDslPackage.ADDITIVE_FEEDBACK__RECOMMENDER:
