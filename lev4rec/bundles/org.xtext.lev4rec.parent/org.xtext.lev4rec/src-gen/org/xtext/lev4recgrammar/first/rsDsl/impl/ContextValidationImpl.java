 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.ContextValidationImpl#getTestContext <em>Test Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextValidationImpl extends ValidationTechniqueImpl implements ContextValidation
{
  ...
  {
    return RsDslPackage.Literals.CONTEXT_VALIDATION;
  }
    ...
    if (testContext != null && testContext.eIsProxy())
    {
      ...
      if (testContext != oldTestContext)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RsDslPackage.CONTEXT_VALIDATION__TEST_CONTEXT, oldTestContext, testContext));
      }
    }
    return testContext;
  }
  ...
  public void setTestContext(RecommendationContext newTestContext)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.CONTEXT_VALIDATION__TEST_CONTEXT, oldTestContext, testContext));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.CONTEXT_VALIDATION__TEST_CONTEXT:
