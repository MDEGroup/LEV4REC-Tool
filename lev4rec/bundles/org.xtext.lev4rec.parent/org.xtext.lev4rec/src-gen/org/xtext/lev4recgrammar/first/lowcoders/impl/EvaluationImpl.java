 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.EvaluationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.EvaluationImpl#getBaselines <em>Baselines</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.EvaluationImpl#getMetrics <em>Metrics</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.lowcoders.impl.EvaluationImpl#getValidationTechnique <em>Validation Technique</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvaluationImpl extends MinimalEObjectImpl.Container implements Evaluation
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LowcodersPackage.EVALUATION__NAME, oldName, name));
  }
  ...
  public EList<String> getBaselines()
  {
    if (baselines == null)
    {
      baselines = new EDataTypeEList<String>(String.class, this, LowcodersPackage.EVALUATION__BASELINES);
    }
    return baselines;
  }
  ...
  public EList<Metric> getMetrics()
  {
    if (metrics == null)
    {
      metrics = new EDataTypeEList<Metric>(Metric.class, this, LowcodersPackage.EVALUATION__METRICS);
    }
    return metrics;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LowcodersPackage.EVALUATION__NAME:
        return getName();
