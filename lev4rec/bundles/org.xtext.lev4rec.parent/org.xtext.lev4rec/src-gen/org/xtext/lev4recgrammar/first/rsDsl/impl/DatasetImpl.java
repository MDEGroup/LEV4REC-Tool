 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DatasetImpl#isIsBuiltIn <em>Is Built In</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DatasetImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DatasetImpl#getPreprocessing <em>Preprocessing</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DatasetImpl#getDatasetManipulationLibrary <em>Dataset Manipulation Library</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DatasetImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DatasetImpl#getIndipendentVariables <em>Indipendent Variables</em>}</li>
 *   <li>{@link org.xtext.lev4recgrammar.first.rsDsl.impl.DatasetImpl#getDataStructure <em>Data Structure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DatasetImpl extends MinimalEObjectImpl.Container implements Dataset
{
  ...
  {
    return RsDslPackage.Literals.DATASET;
  }
  ...
  public void setIsBuiltIn(boolean newIsBuiltIn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.DATASET__IS_BUILT_IN, oldIsBuiltIn, isBuiltIn));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.DATASET__NAME, oldName, name));
  }
  ...
  public EList<PreprocessingTechnique> getPreprocessing()
  {
    ...
    {
      preprocessing = new EDataTypeEList<PreprocessingTechnique>(PreprocessingTechnique.class, this, RsDslPackage.DATASET__PREPROCESSING);
    }
  ...
  public EList<DatasetManipulationLibrary> getDatasetManipulationLibrary()
  {
    ...
    {
      datasetManipulationLibrary = new EDataTypeEList<DatasetManipulationLibrary>(DatasetManipulationLibrary.class, this, RsDslPackage.DATASET__DATASET_MANIPULATION_LIBRARY);
    }
  ...
  public void setPath(String newPath)
  {
    ...
    path = newPath;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.DATASET__PATH, oldPath, path));
  }
  ...
  public EList<Variable> getIndipendentVariables()
  {
    ...
    {
      indipendentVariables = new EObjectContainmentEList<Variable>(Variable.class, this, RsDslPackage.DATASET__INDIPENDENT_VARIABLES);
    }
  ...
  public NotificationChain basicSetDataStructure(DataStructure newDataStructure, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RsDslPackage.DATASET__DATA_STRUCTURE, oldDataStructure, newDataStructure);
  ...
  public void setDataStructure(DataStructure newDataStructure)
  {
    if (newDataStructure != dataStructure)
    {
      ...
      if (dataStructure != null)
        msgs = ((InternalEObject)dataStructure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RsDslPackage.DATASET__DATA_STRUCTURE, null, msgs);
      if (newDataStructure != null)
        msgs = ((InternalEObject)newDataStructure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RsDslPackage.DATASET__DATA_STRUCTURE, null, msgs);
      msgs = basicSetDataStructure(newDataStructure, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RsDslPackage.DATASET__DATA_STRUCTURE, newDataStructure, newDataStructure));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RsDslPackage.DATASET__INDIPENDENT_VARIABLES:
        return ((InternalEList<?>)getIndipendentVariables()).basicRemove(otherEnd, msgs);
      case RsDslPackage.DATASET__DATA_STRUCTURE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RsDslPackage.DATASET__IS_BUILT_IN:
        return isIsBuiltIn();
      case RsDslPackage.DATASET__NAME:
        return getName();
      case RsDslPackage.DATASET__PREPROCESSING:
        return getPreprocessing();
      case RsDslPackage.DATASET__DATASET_MANIPULATION_LIBRARY:
        return getDatasetManipulationLibrary();
      case RsDslPackage.DATASET__PATH:
        return getPath();
      case RsDslPackage.DATASET__INDIPENDENT_VARIABLES:
