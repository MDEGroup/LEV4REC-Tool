...
/**
 * This is the item provider adapter for a {@link lowcoders.Graph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphItemProvider extends DataStructureItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Graph_nodes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Graph_nodes_feature", "_UI_Graph_type"),
				 LowcodersPackage.Literals.GRAPH__NODES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LowcodersPackage.Literals.GRAPH__RELATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LowcodersPackage.Literals.GRAPH__RELATIONS,
				 LowcodersFactory.eINSTANCE.createVariableRelation()));
	}
