...
/**
 * This is the item provider adapter for a {@link lowcoders.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_File_sourcePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_File_sourcePath_feature", "_UI_File_type"),
				 LowcodersPackage.Literals.FILE__SOURCE_PATH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LowcodersPackage.Literals.FILE__ENCODING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
