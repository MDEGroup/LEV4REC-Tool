package it.disim.univaq.lowcode.acceleo.runner;
...
import it.disim.univaq.lowcode.acceleo.main.Generate;
...
public class Runner {
	...
	public static void main(String[] args) {
		...
		try {
			...
			r.run("/Users/juri/development/git/LEV4REC/lev4rec/bundles/lev4rec.feature.model/configs/Aurora.xmi", "output");
