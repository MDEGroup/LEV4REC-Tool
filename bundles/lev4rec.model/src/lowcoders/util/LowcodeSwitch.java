 ...
 * <!-- end-user-doc -->
 * @see lowcoders.LowcodePackage
 * @generated
 */
public class LowcodeSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static LowcodePackage modelPackage;
	 ...
	 * @generated
	 */
	public LowcodeSwitch() {
		if (modelPackage == null) {
			modelPackage = LowcodePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LowcodePackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LowcodePackage.DATASET: {
			...
			case LowcodePackage.DATA_SOURCE: {
			...
			case LowcodePackage.PRESENTATION_LAYER: {
			...
			case LowcodePackage.WEB_INTERFACE: {
			...
			case LowcodePackage.WEB_APPLICATION: {
			...
			case LowcodePackage.IDE_INTEGRATION: {
			...
			case LowcodePackage.TRAVERSABLE_GRAPH: {
			...
			case LowcodePackage.EVALUATION: {
			...
			case LowcodePackage.VALIDATION_TECHNIQUE: {
			...
			case LowcodePackage.UNSUPERVISED_DATASET: {
			...
			case LowcodePackage.SUPERVISED_DATASET: {
			...
			case LowcodePackage.COMMUNICATION_CHANNEL: {
			...
			case LowcodePackage.BUG_TRACKING_SYSTEM: {
			...
			case LowcodePackage.DATA_STRUCTURE: {
			...
			case LowcodePackage.TEXTUAL_CONTENT: {
			...
			case LowcodePackage.RECOMMENDATION_SYSTEM: {
			...
			case LowcodePackage.MACHINE_LEARNING_BASED_RS: {
			...
			case LowcodePackage.MEMORY_BASED_RS_NOTSURE: {
			...
			case LowcodePackage.FILTERING_RS: {
			...
			case LowcodePackage.DATA_MINING_RS: {
			...
			case LowcodePackage.CUSTOM_RECOMMENDER_SOREC: {
			...
			case LowcodePackage.RECOMMENDATION_SETTING: {
			...
			case LowcodePackage.GENETIC_ALGORITHM: {
			...
			case LowcodePackage.USER_STUDY: {
			...
			case LowcodePackage.CROSS_VALIDATION: {
			...
			case LowcodePackage.RECOMMENDATION_CONTEXT: {
			...
			case LowcodePackage.DEPENDENCY_MANAGER: {
			...
			case LowcodePackage.RECOMMENDED_ITEM: {
			...
			case LowcodePackage.CONTEXT_VALIDATION: {
			...
			case LowcodePackage.RAW_OUTCOMES: {
			...
			case LowcodePackage.RANDOM_SPLITTING: {
			...
			case LowcodePackage.AUTOMATED_VALIDATION: {
			...
			case LowcodePackage.CONVOLUTIONAL_NN: {
			...
			case LowcodePackage.RECURRENT_NN: {
			...
			case LowcodePackage.DECISION_TREE: {
			...
			case LowcodePackage.FEED_FORWARD_NN: {
