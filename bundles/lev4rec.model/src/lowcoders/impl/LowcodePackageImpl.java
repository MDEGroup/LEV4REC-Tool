 ...
 * @generated
 */
public class LowcodePackageImpl extends EPackageImpl implements LowcodePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see lowcoders.LowcodePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private LowcodePackageImpl() {
		super(eNS_URI, LowcodeFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link LowcodePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static LowcodePackage init() {
		if (isInited) return (LowcodePackage)EPackage.Registry.INSTANCE.getEPackage(LowcodePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredLowcodePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		LowcodePackageImpl theLowcodePackage = registeredLowcodePackage instanceof LowcodePackageImpl ? (LowcodePackageImpl)registeredLowcodePackage : new LowcodePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theLowcodePackage.createPackageContents();

		// Initialize created meta-data
		theLowcodePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theLowcodePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(LowcodePackage.eNS_URI, theLowcodePackage);
		return theLowcodePackage;
	}
	 ...
	 */
	@Override
	public LowcodeFactory getLowcodeFactory() {
		return (LowcodeFactory)getEFactoryInstance();
	}
