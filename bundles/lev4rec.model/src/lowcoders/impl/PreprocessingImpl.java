...
public class PreprocessingImpl extends MinimalEObjectImpl.Container implements Preprocessing {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.PREPROCESSING;
	}
	...
	public EList<PreprocessingTechnique> getPreprocessigTechnique() {
		if (preprocessigTechnique == null) {
			preprocessigTechnique = new EDataTypeUniqueEList<PreprocessingTechnique>(PreprocessingTechnique.class, this, LowcodePackage.PREPROCESSING__PREPROCESSIG_TECHNIQUE);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.PREPROCESSING__PREPROCESSIG_TECHNIQUE:
