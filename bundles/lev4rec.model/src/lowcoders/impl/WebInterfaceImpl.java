...
public class WebInterfaceImpl extends PresentationLayerImpl implements WebInterface {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.WEB_INTERFACE;
	}
	...
	public void setLibrary(WebInterfaceLibrary newLibrary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.WEB_INTERFACE__LIBRARY, oldLibrary, library));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.WEB_INTERFACE__LIBRARY:
				return getLibrary();
		}
