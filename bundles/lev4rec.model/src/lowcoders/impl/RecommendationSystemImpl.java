...
public abstract class RecommendationSystemImpl extends NamedElementImpl implements RecommendationSystem {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.RECOMMENDATION_SYSTEM;
	}
	...
	public EList<RecommendationSetting> getRecommenderSettings() {
		if (recommenderSettings == null) {
			recommenderSettings = new EObjectContainmentEList<RecommendationSetting>(RecommendationSetting.class, this, LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDER_SETTINGS);
		}
	...
	public NotificationChain basicSetRecommendationScope(RecommendedItem newRecommendationScope, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_SCOPE, oldRecommendationScope, newRecommendationScope);
	...
	public void setRecommendationScope(RecommendedItem newRecommendationScope) {
		if (newRecommendationScope != recommendationScope) {
			...
			if (recommendationScope != null)
				msgs = ((InternalEObject)recommendationScope).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_SCOPE, null, msgs);
			if (newRecommendationScope != null)
				msgs = ((InternalEObject)newRecommendationScope).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_SCOPE, null, msgs);
			msgs = basicSetRecommendationScope(newRecommendationScope, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_SCOPE, newRecommendationScope, newRecommendationScope));
	}
	...
	public NotificationChain basicSetRecommendationContext(RecommendationContext newRecommendationContext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_CONTEXT, oldRecommendationContext, newRecommendationContext);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRecommendationContext(RecommendationContext newRecommendationContext) {
		if (newRecommendationContext != recommendationContext) {
			...
			if (recommendationContext != null)
				msgs = ((InternalEObject)recommendationContext).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_CONTEXT, null, msgs);
			if (newRecommendationContext != null)
				msgs = ((InternalEObject)newRecommendationContext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_CONTEXT, null, msgs);
			msgs = basicSetRecommendationContext(newRecommendationContext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_CONTEXT, newRecommendationContext, newRecommendationContext));
	}
	...
	public void setGenerator(PyLibType newGenerator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.RECOMMENDATION_SYSTEM__GENERATOR, oldGenerator, generator));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDER_SETTINGS:
				return ((InternalEList<?>)getRecommenderSettings()).basicRemove(otherEnd, msgs);
			case LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_SCOPE:
				return basicSetRecommendationScope(null, msgs);
			case LowcodePackage.RECOMMENDATION_SYSTEM__RECOMMENDATION_CONTEXT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LowcodePackage.RECOMMENDATION_SYSTEM__GENERATOR:
				return getGenerator();
		}
