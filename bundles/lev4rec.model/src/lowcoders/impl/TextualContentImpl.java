...
public class TextualContentImpl extends DataStructureImpl implements TextualContent {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.TEXTUAL_CONTENT;
	}
		...
		if (contents != null && contents.eIsProxy()) {
			...
			if (contents != oldContents) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LowcodePackage.TEXTUAL_CONTENT__CONTENTS, oldContents, contents));
			}
		}
		return contents;
	}
	...
	public void setContents(Variable newContents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.TEXTUAL_CONTENT__CONTENTS, oldContents, contents));
	}
	...
	public void setRootPath(String newRootPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.TEXTUAL_CONTENT__ROOT_PATH, oldRootPath, rootPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.TEXTUAL_CONTENT__CONTENTS:
				if (resolve) return getContents();
				return basicGetContents();
			case LowcodePackage.TEXTUAL_CONTENT__ROOT_PATH:
				return getRootPath();
		}
