...
public class CrossValidationImpl extends AutomatedValidationImpl implements CrossValidation {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.CROSS_VALIDATION;
	}
	...
	public void setNumberOfFold(int newNumberOfFold) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.CROSS_VALIDATION__NUMBER_OF_FOLD, oldNumberOfFold, numberOfFold));
	}
	...
	public NotificationChain basicSetGroundTruthExtractor(GroundTruthExtraction newGroundTruthExtractor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LowcodePackage.CROSS_VALIDATION__GROUND_TRUTH_EXTRACTOR, oldGroundTruthExtractor, newGroundTruthExtractor);
	...
	public void setGroundTruthExtractor(GroundTruthExtraction newGroundTruthExtractor) {
		if (newGroundTruthExtractor != groundTruthExtractor) {
			...
			if (groundTruthExtractor != null)
				msgs = ((InternalEObject)groundTruthExtractor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.CROSS_VALIDATION__GROUND_TRUTH_EXTRACTOR, null, msgs);
			if (newGroundTruthExtractor != null)
				msgs = ((InternalEObject)newGroundTruthExtractor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.CROSS_VALIDATION__GROUND_TRUTH_EXTRACTOR, null, msgs);
			msgs = basicSetGroundTruthExtractor(newGroundTruthExtractor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.CROSS_VALIDATION__GROUND_TRUTH_EXTRACTOR, newGroundTruthExtractor, newGroundTruthExtractor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LowcodePackage.CROSS_VALIDATION__GROUND_TRUTH_EXTRACTOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.CROSS_VALIDATION__NUMBER_OF_FOLD:
