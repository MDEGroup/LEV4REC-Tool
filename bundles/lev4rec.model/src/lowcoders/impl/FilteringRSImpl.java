...
public class FilteringRSImpl extends RecommendationSystemImpl implements FilteringRS {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.FILTERING_RS;
	}
	...
	public void setFilteringRSAlgorithm(FilteringRSAlgorithm newFilteringRSAlgorithm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FILTERING_RS__FILTERING_RS_ALGORITHM, oldFilteringRSAlgorithm, filteringRSAlgorithm));
	}
	...
	public void setSimilarityCalculator(SimilarityFunction newSimilarityCalculator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FILTERING_RS__SIMILARITY_CALCULATOR, oldSimilarityCalculator, similarityCalculator));
	}
	...
	public void setCutoff(int newCutoff) {
		...
		cutoff = newCutoff;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FILTERING_RS__CUTOFF, oldCutoff, cutoff));
	}
	...
	public void setNeighborhood(int newNeighborhood) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FILTERING_RS__NEIGHBORHOOD, oldNeighborhood, neighborhood));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.FILTERING_RS__FILTERING_RS_ALGORITHM:
				return getFilteringRSAlgorithm();
			case LowcodePackage.FILTERING_RS__SIMILARITY_CALCULATOR:
				return getSimilarityCalculator();
			case LowcodePackage.FILTERING_RS__CUTOFF:
				return getCutoff();
			case LowcodePackage.FILTERING_RS__NEIGHBORHOOD:
