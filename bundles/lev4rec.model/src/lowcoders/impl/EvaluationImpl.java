...
public class EvaluationImpl extends NamedElementImpl implements Evaluation {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.EVALUATION;
	}
	...
	public EList<String> getBaselines() {
		if (baselines == null) {
			baselines = new EDataTypeUniqueEList<String>(String.class, this, LowcodePackage.EVALUATION__BASELINES);
		}
		return baselines;
	}
	...
	public EList<Metric> getMetrics() {
		if (metrics == null) {
			metrics = new EDataTypeUniqueEList<Metric>(Metric.class, this, LowcodePackage.EVALUATION__METRICS);
		}
		return metrics;
	}
	...
	public EList<ValidationTechnique> getValidationtechnique() {
		if (validationtechnique == null) {
			validationtechnique = new EObjectContainmentEList<ValidationTechnique>(ValidationTechnique.class, this, LowcodePackage.EVALUATION__VALIDATIONTECHNIQUE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LowcodePackage.EVALUATION__VALIDATIONTECHNIQUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.EVALUATION__BASELINES:
				return getBaselines();
			case LowcodePackage.EVALUATION__METRICS:
				return getMetrics();
			case LowcodePackage.EVALUATION__VALIDATIONTECHNIQUE:
