...
public class SVMImpl extends MachineLearningBasedRSImpl implements SVM {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.SVM;
	}
	...
	public void setKernel(KernelType newKernel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.SVM__KERNEL, oldKernel, kernel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.SVM__KERNEL:
				return getKernel();
		}
