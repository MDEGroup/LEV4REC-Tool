...
public class CodeRepositoryImpl extends DataSourceImpl implements CodeRepository {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.CODE_REPOSITORY;
	}
	...
	public void setMetadata(boolean newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.CODE_REPOSITORY__METADATA, oldMetadata, metadata));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.CODE_REPOSITORY__METADATA:
				return isMetadata();
		}
