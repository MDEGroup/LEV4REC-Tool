...
public class WebApplicationImpl extends NamedElementImpl implements WebApplication {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.WEB_APPLICATION;
	}
		...
		if (recommendations != null && recommendations.eIsProxy()) {
			...
			if (recommendations != oldRecommendations) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LowcodePackage.WEB_APPLICATION__RECOMMENDATIONS, oldRecommendations, recommendations));
			}
		}
	...
	public void setRecommendations(RecommendedItem newRecommendations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.WEB_APPLICATION__RECOMMENDATIONS, oldRecommendations, recommendations));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.WEB_APPLICATION__RECOMMENDATIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == PresentationLayer.class) {
			switch (derivedFeatureID) {
				case LowcodePackage.WEB_APPLICATION__RECOMMENDATIONS: return LowcodePackage.PRESENTATION_LAYER__RECOMMENDATIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PresentationLayer.class) {
			switch (baseFeatureID) {
				case LowcodePackage.PRESENTATION_LAYER__RECOMMENDATIONS: return LowcodePackage.WEB_APPLICATION__RECOMMENDATIONS;
				default: return -1;
			}
		}
