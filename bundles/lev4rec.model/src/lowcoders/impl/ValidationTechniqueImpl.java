...
public abstract class ValidationTechniqueImpl extends NamedElementImpl implements ValidationTechnique {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.VALIDATION_TECHNIQUE;
	}
	...
	public void setNOfRecommendations(int newNOfRecommendations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.VALIDATION_TECHNIQUE__NOF_RECOMMENDATIONS, oldNOfRecommendations, nOfRecommendations));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.VALIDATION_TECHNIQUE__NOF_RECOMMENDATIONS:
