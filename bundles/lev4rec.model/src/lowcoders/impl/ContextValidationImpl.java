...
public class ContextValidationImpl extends ValidationTechniqueImpl implements ContextValidation {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.CONTEXT_VALIDATION;
	}
		...
		if (testContext != null && testContext.eIsProxy()) {
			...
			if (testContext != oldTestContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LowcodePackage.CONTEXT_VALIDATION__TEST_CONTEXT, oldTestContext, testContext));
			}
		}
		return testContext;
	}
	...
	public void setTestContext(RecommendationContext newTestContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.CONTEXT_VALIDATION__TEST_CONTEXT, oldTestContext, testContext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.CONTEXT_VALIDATION__TEST_CONTEXT:
