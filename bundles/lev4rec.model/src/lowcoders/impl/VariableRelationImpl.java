...
public class VariableRelationImpl extends MinimalEObjectImpl.Container implements VariableRelation {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.VARIABLE_RELATION;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LowcodePackage.VARIABLE_RELATION__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Variable newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.VARIABLE_RELATION__SOURCE, oldSource, source));
	}
	...
	public Variable getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LowcodePackage.VARIABLE_RELATION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Variable newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.VARIABLE_RELATION__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.VARIABLE_RELATION__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case LowcodePackage.VARIABLE_RELATION__TARGET:
