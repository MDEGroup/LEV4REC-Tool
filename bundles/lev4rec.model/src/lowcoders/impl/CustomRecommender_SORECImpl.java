...
public class CustomRecommender_SORECImpl extends RecommendationSystemImpl implements CustomRecommender_SOREC {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.CUSTOM_RECOMMENDER_SOREC;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.CUSTOM_RECOMMENDER_SOREC__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<String> getRequiredTools() {
		if (requiredTools == null) {
			requiredTools = new EDataTypeUniqueEList<String>(String.class, this, LowcodePackage.CUSTOM_RECOMMENDER_SOREC__REQUIRED_TOOLS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.CUSTOM_RECOMMENDER_SOREC__DESCRIPTION:
				return getDescription();
			case LowcodePackage.CUSTOM_RECOMMENDER_SOREC__REQUIRED_TOOLS:
