 ...
 * </ul>
 *
 * @see lowcoders.LowcodePackage#getRecommendationSetting()
 * @model
 * @generated
 */
public interface RecommendationSetting extends EObject {
	 ...
	 * @see #setKey(String)
	 * @see lowcoders.LowcodePackage#getRecommendationSetting_Key()
	 * @model required="true"
	 * @generated
	 */
	String getKey();
	 ...
	 * @see #setValue(String)
	 * @see lowcoders.LowcodePackage#getRecommendationSetting_Value()
	 * @model required="true"
	 * @generated
	 */
	String getValue();
