...
public class GeneticAlgorithmImpl extends RecommendationSystemImpl implements GeneticAlgorithm {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.GENETIC_ALGORITHM;
	}
	...
	public void setFitnessFunction(String newFitnessFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.GENETIC_ALGORITHM__FITNESS_FUNCTION, oldFitnessFunction, fitnessFunction));
	}
	...
	public void setSearchStrategy(SearchStrategy newSearchStrategy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.GENETIC_ALGORITHM__SEARCH_STRATEGY, oldSearchStrategy, searchStrategy));
	}
	...
	public void setMutationOperator(MutationOperation newMutationOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.GENETIC_ALGORITHM__MUTATION_OPERATOR, oldMutationOperator, mutationOperator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.GENETIC_ALGORITHM__FITNESS_FUNCTION:
				return getFitnessFunction();
			case LowcodePackage.GENETIC_ALGORITHM__SEARCH_STRATEGY:
				return getSearchStrategy();
			case LowcodePackage.GENETIC_ALGORITHM__MUTATION_OPERATOR:
