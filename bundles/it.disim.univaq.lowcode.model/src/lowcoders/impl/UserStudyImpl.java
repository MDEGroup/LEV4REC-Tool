...
public class UserStudyImpl extends ValidationTechniqueImpl implements UserStudy {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.USER_STUDY;
	}
	...
	public void setType(UserStudyType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.USER_STUDY__TYPE, oldType, type));
	}
	...
	public void setAnalysis(UserStudyAnalysis newAnalysis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.USER_STUDY__ANALYSIS, oldAnalysis, analysis));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.USER_STUDY__TYPE:
				return getType();
			case LowcodePackage.USER_STUDY__ANALYSIS:
				return getAnalysis();
		}
