...
public class GraphImpl extends DataStructureImpl implements Graph {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.GRAPH;
	}
	...
	public EList<Variable> getNodes() {
		if (nodes == null) {
			nodes = new EObjectResolvingEList<Variable>(Variable.class, this, LowcodePackage.GRAPH__NODES);
		}
		return nodes;
	}
	...
	public NotificationChain basicSetRelations(VariableRelation newRelations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LowcodePackage.GRAPH__RELATIONS, oldRelations, newRelations);
	...
	public void setRelations(VariableRelation newRelations) {
		if (newRelations != relations) {
			...
			if (relations != null)
				msgs = ((InternalEObject)relations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.GRAPH__RELATIONS, null, msgs);
			if (newRelations != null)
				msgs = ((InternalEObject)newRelations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.GRAPH__RELATIONS, null, msgs);
			msgs = basicSetRelations(newRelations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.GRAPH__RELATIONS, newRelations, newRelations));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LowcodePackage.GRAPH__RELATIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.GRAPH__NODES:
				return getNodes();
			case LowcodePackage.GRAPH__RELATIONS:
				return getRelations();
		}
