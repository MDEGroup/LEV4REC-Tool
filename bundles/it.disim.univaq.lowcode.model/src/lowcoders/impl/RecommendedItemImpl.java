...
public class RecommendedItemImpl extends NamedElementImpl implements RecommendedItem {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.RECOMMENDED_ITEM;
	}
	...
	public EList<Variable> getOutcame() {
		if (outcame == null) {
			outcame = new EObjectResolvingEList<Variable>(Variable.class, this, LowcodePackage.RECOMMENDED_ITEM__OUTCAME);
		}
		return outcame;
	}
	...
	public void setOrdered(boolean newOrdered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.RECOMMENDED_ITEM__ORDERED, oldOrdered, ordered));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.RECOMMENDED_ITEM__OUTCAME:
				return getOutcame();
			case LowcodePackage.RECOMMENDED_ITEM__ORDERED:
				return isOrdered();
		}
