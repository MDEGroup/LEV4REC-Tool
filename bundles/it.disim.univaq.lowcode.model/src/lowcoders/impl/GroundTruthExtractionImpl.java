...
public class GroundTruthExtractionImpl extends MinimalEObjectImpl.Container implements GroundTruthExtraction {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.GROUND_TRUTH_EXTRACTION;
	}
	...
	public void setSizeGT(String newSizeGT) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.GROUND_TRUTH_EXTRACTION__SIZE_GT, oldSizeGT, sizeGT));
	}
	...
	public EList<String> getSplittingRules() {
		if (splittingRules == null) {
			splittingRules = new EDataTypeUniqueEList<String>(String.class, this, LowcodePackage.GROUND_TRUTH_EXTRACTION__SPLITTING_RULES);
		}
	...
	public Variable getTargetVariable() {
		if (targetVariable != null && targetVariable.eIsProxy()) {
			...
			if (targetVariable != oldTargetVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LowcodePackage.GROUND_TRUTH_EXTRACTION__TARGET_VARIABLE, oldTargetVariable, targetVariable));
			}
		}
	...
	public void setTargetVariable(Variable newTargetVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.GROUND_TRUTH_EXTRACTION__TARGET_VARIABLE, oldTargetVariable, targetVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.GROUND_TRUTH_EXTRACTION__SIZE_GT:
				return getSizeGT();
			case LowcodePackage.GROUND_TRUTH_EXTRACTION__SPLITTING_RULES:
				return getSplittingRules();
			case LowcodePackage.GROUND_TRUTH_EXTRACTION__TARGET_VARIABLE:
