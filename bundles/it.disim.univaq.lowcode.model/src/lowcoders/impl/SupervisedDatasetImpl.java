...
public class SupervisedDatasetImpl extends DatasetImpl implements SupervisedDataset {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.SUPERVISED_DATASET;
	}
	...
	public NotificationChain basicSetDependatVariable(Variable newDependatVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LowcodePackage.SUPERVISED_DATASET__DEPENDAT_VARIABLE, oldDependatVariable, newDependatVariable);
	...
	public void setDependatVariable(Variable newDependatVariable) {
		if (newDependatVariable != dependatVariable) {
			...
			if (dependatVariable != null)
				msgs = ((InternalEObject)dependatVariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.SUPERVISED_DATASET__DEPENDAT_VARIABLE, null, msgs);
			if (newDependatVariable != null)
				msgs = ((InternalEObject)newDependatVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.SUPERVISED_DATASET__DEPENDAT_VARIABLE, null, msgs);
			msgs = basicSetDependatVariable(newDependatVariable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.SUPERVISED_DATASET__DEPENDAT_VARIABLE, newDependatVariable, newDependatVariable));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LowcodePackage.SUPERVISED_DATASET__DEPENDAT_VARIABLE:
