...
public class FileImpl extends DataSourceImpl implements File {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.FILE;
	}
	...
	public void setSourcePath(String newSourcePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FILE__SOURCE_PATH, oldSourcePath, sourcePath));
	}
	...
	public void setEncoding(String newEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FILE__ENCODING, oldEncoding, encoding));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.FILE__SOURCE_PATH:
				return getSourcePath();
			case LowcodePackage.FILE__ENCODING:
				return getEncoding();
		}
