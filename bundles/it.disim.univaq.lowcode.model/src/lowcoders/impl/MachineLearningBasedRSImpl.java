...
public class MachineLearningBasedRSImpl extends RecommendationSystemImpl implements MachineLearningBasedRS {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.MACHINE_LEARNING_BASED_RS;
	}
	...
	public void setNumEpochs(int newNumEpochs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.MACHINE_LEARNING_BASED_RS__NUM_EPOCHS, oldNumEpochs, numEpochs));
	}
	...
	public void setLearningRate(int newLearningRate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.MACHINE_LEARNING_BASED_RS__LEARNING_RATE, oldLearningRate, learningRate));
	}
	...
	public void setMiniBatchSize(int newMiniBatchSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.MACHINE_LEARNING_BASED_RS__MINI_BATCH_SIZE, oldMiniBatchSize, miniBatchSize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.MACHINE_LEARNING_BASED_RS__NUM_EPOCHS:
				return getNumEpochs();
			case LowcodePackage.MACHINE_LEARNING_BASED_RS__LEARNING_RATE:
				return getLearningRate();
			case LowcodePackage.MACHINE_LEARNING_BASED_RS__MINI_BATCH_SIZE:
