...
public class VariableImpl extends NamedElementImpl implements Variable {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.VARIABLE;
	}
	...
	public NotificationChain basicSetDataSource(DataSource newDataSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LowcodePackage.VARIABLE__DATA_SOURCE, oldDataSource, newDataSource);
	...
	public void setDataSource(DataSource newDataSource) {
		if (newDataSource != dataSource) {
			...
			if (dataSource != null)
				msgs = ((InternalEObject)dataSource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.VARIABLE__DATA_SOURCE, null, msgs);
			if (newDataSource != null)
				msgs = ((InternalEObject)newDataSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.VARIABLE__DATA_SOURCE, null, msgs);
			msgs = basicSetDataSource(newDataSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.VARIABLE__DATA_SOURCE, newDataSource, newDataSource));
	}
	...
	public NotificationChain basicSetPreprocessing(Preprocessing newPreprocessing, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LowcodePackage.VARIABLE__PREPROCESSING, oldPreprocessing, newPreprocessing);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPreprocessing(Preprocessing newPreprocessing) {
		if (newPreprocessing != preprocessing) {
			...
			if (preprocessing != null)
				msgs = ((InternalEObject)preprocessing).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.VARIABLE__PREPROCESSING, null, msgs);
			if (newPreprocessing != null)
				msgs = ((InternalEObject)newPreprocessing).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.VARIABLE__PREPROCESSING, null, msgs);
			msgs = basicSetPreprocessing(newPreprocessing, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.VARIABLE__PREPROCESSING, newPreprocessing, newPreprocessing));
	}
	...
	public void setType(VariableType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.VARIABLE__TYPE, oldType, type));
	}
	...
	public void setIsMissingValueAllowed(boolean newIsMissingValueAllowed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.VARIABLE__IS_MISSING_VALUE_ALLOWED, oldIsMissingValueAllowed, isMissingValueAllowed));
	}
	...
	public void setIsMultiple(boolean newIsMultiple) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.VARIABLE__IS_MULTIPLE, oldIsMultiple, isMultiple));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LowcodePackage.VARIABLE__DATA_SOURCE:
				return basicSetDataSource(null, msgs);
			case LowcodePackage.VARIABLE__PREPROCESSING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LowcodePackage.VARIABLE__TYPE:
				return getType();
			case LowcodePackage.VARIABLE__IS_MISSING_VALUE_ALLOWED:
				return isIsMissingValueAllowed();
			case LowcodePackage.VARIABLE__IS_MULTIPLE:
				return isIsMultiple();
		}
