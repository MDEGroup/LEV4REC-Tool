...
public abstract class DatasetImpl extends NamedElementImpl implements Dataset {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.DATASET;
	}
	...
	public EList<Variable> getIndipendentVariables() {
		if (indipendentVariables == null) {
			indipendentVariables = new EObjectContainmentEList<Variable>(Variable.class, this, LowcodePackage.DATASET__INDIPENDENT_VARIABLES);
		}
	...
	public NotificationChain basicSetDataStructure(DataStructure newDataStructure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LowcodePackage.DATASET__DATA_STRUCTURE, oldDataStructure, newDataStructure);
	...
	public void setDataStructure(DataStructure newDataStructure) {
		if (newDataStructure != dataStructure) {
			...
			if (dataStructure != null)
				msgs = ((InternalEObject)dataStructure).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.DATASET__DATA_STRUCTURE, null, msgs);
			if (newDataStructure != null)
				msgs = ((InternalEObject)newDataStructure).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LowcodePackage.DATASET__DATA_STRUCTURE, null, msgs);
			msgs = basicSetDataStructure(newDataStructure, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.DATASET__DATA_STRUCTURE, newDataStructure, newDataStructure));
	}
	...
	public EList<PreprocessingTechnique> getPreprocessing() {
		if (preprocessing == null) {
			preprocessing = new EDataTypeUniqueEList<PreprocessingTechnique>(PreprocessingTechnique.class, this, LowcodePackage.DATASET__PREPROCESSING);
		}
	...
	public EList<DatasetManipulationLibrary> getDatasetManipulationLibrary() {
		if (datasetManipulationLibrary == null) {
			datasetManipulationLibrary = new EDataTypeUniqueEList<DatasetManipulationLibrary>(DatasetManipulationLibrary.class, this, LowcodePackage.DATASET__DATASET_MANIPULATION_LIBRARY);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LowcodePackage.DATASET__INDIPENDENT_VARIABLES:
				return ((InternalEList<?>)getIndipendentVariables()).basicRemove(otherEnd, msgs);
			case LowcodePackage.DATASET__DATA_STRUCTURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LowcodePackage.DATASET__PREPROCESSING:
				return getPreprocessing();
			case LowcodePackage.DATASET__DATASET_MANIPULATION_LIBRARY:
