...
public class DeepNNImpl extends MachineLearningBasedRSImpl implements DeepNN {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.DEEP_NN;
	}
	...
	public void setNumHiddenLayer(int newNumHiddenLayer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.DEEP_NN__NUM_HIDDEN_LAYER, oldNumHiddenLayer, numHiddenLayer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.DEEP_NN__NUM_HIDDEN_LAYER:
