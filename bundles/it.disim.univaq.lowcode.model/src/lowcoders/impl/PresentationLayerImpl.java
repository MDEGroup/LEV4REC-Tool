...
public abstract class PresentationLayerImpl extends NamedElementImpl implements PresentationLayer {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.PRESENTATION_LAYER;
	}
		...
		if (recommendations != null && recommendations.eIsProxy()) {
			...
			if (recommendations != oldRecommendations) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LowcodePackage.PRESENTATION_LAYER__RECOMMENDATIONS, oldRecommendations, recommendations));
			}
		}
	...
	public void setRecommendations(RecommendedItem newRecommendations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.PRESENTATION_LAYER__RECOMMENDATIONS, oldRecommendations, recommendations));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.PRESENTATION_LAYER__RECOMMENDATIONS:
