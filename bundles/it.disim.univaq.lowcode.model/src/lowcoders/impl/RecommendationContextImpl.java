...
public class RecommendationContextImpl extends NamedElementImpl implements RecommendationContext {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.RECOMMENDATION_CONTEXT;
	}
		...
		if (usercontext != null && usercontext.eIsProxy()) {
			...
			if (usercontext != oldUsercontext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LowcodePackage.RECOMMENDATION_CONTEXT__USERCONTEXT, oldUsercontext, usercontext));
			}
		}
		return usercontext;
	}
	...
	public void setUsercontext(DataStructure newUsercontext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.RECOMMENDATION_CONTEXT__USERCONTEXT, oldUsercontext, usercontext));
	}
	...
	public void setIsProactiveSystem(boolean newIsProactiveSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.RECOMMENDATION_CONTEXT__IS_PROACTIVE_SYSTEM, oldIsProactiveSystem, isProactiveSystem));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.RECOMMENDATION_CONTEXT__USERCONTEXT:
				if (resolve) return getUsercontext();
				return basicGetUsercontext();
			case LowcodePackage.RECOMMENDATION_CONTEXT__IS_PROACTIVE_SYSTEM:
