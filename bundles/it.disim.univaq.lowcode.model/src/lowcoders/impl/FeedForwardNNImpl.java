...
public class FeedForwardNNImpl extends MachineLearningBasedRSImpl implements FeedForwardNN {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.FEED_FORWARD_NN;
	}
	...
	public void setSolver(SolverType newSolver) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FEED_FORWARD_NN__SOLVER, oldSolver, solver));
	}
	...
	public void setAlpha(float newAlpha) {
		...
		alpha = newAlpha;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FEED_FORWARD_NN__ALPHA, oldAlpha, alpha));
	}
	...
	public void setActivationFunction(ActivationType newActivationFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FEED_FORWARD_NN__ACTIVATION_FUNCTION, oldActivationFunction, activationFunction));
	}
	...
	public void setRandomState(int newRandomState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.FEED_FORWARD_NN__RANDOM_STATE, oldRandomState, randomState));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.FEED_FORWARD_NN__SOLVER:
				return getSolver();
			case LowcodePackage.FEED_FORWARD_NN__ALPHA:
				return getAlpha();
			case LowcodePackage.FEED_FORWARD_NN__ACTIVATION_FUNCTION:
				return getActivationFunction();
			case LowcodePackage.FEED_FORWARD_NN__RANDOM_STATE:
