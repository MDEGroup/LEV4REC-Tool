...
public class DataMiningRSImpl extends RecommendationSystemImpl implements DataMiningRS {
	...
	protected EClass eStaticClass() {
		return LowcodePackage.Literals.DATA_MINING_RS;
	}
	...
	public void setDataMiningRSAlgorithm(DataMiningRSAlgorithm newDataMiningRSAlgorithm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LowcodePackage.DATA_MINING_RS__DATA_MINING_RS_ALGORITHM, oldDataMiningRSAlgorithm, dataMiningRSAlgorithm));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LowcodePackage.DATA_MINING_RS__DATA_MINING_RS_ALGORITHM:
